...
class ResumeAnalyzer:
    ...
    def check_resume_sections(self, text):
        ...
        essential_sections = {
            ...
            'education': [
                'education',
                'university',
                'college','degree','academic','school','institute','bachelor','master','b.tech','m.tech','b.e','m.e','b.sc','m.sc',
                'diploma'
                ],
            'experience': [
                'experience',
        ...
        try:
                ...
                for page in pdf_reader.pages:
                    try:
                        ...
                        print(f"Could not extract one page: {page_error}")
    ...
    def extract_personal_info(self, text):
        ...
        linkedin_pattern = r'(?:linkedin\.com/in/[\w-]+|\blinkedin\b)'
        github_pattern = r'github\.com/[\w-]+|\bgithub\b'
    ...
    def extract_education(self, text):
        ...
        education_keywords = [
            ...
            'm.com', 'b.cs-it', 'imca', 'bba', 'mba', 'honors', 'scholarship','engineering'
        ]
    ...
    def extract_skills(self, text):
        ...
        section_keywords = self.document_types['resume']
        ...
        for i, line in enumerate(lines):
            ...
            if not line:
                continue
            cleaned_line = line.lower().rstrip(':').strip()
            
            if cleaned_line in [keyword.lower() for keyword in skills_keywords]:
                skills_start = i + 1
                break
        ...
        for line in lines[skills_start:]:
            ...
            cleaned_line = line.lower().rstrip(':').strip()
            if cleaned_line in [keyword.lower() for keyword in section_keywords]:
                break
    ...
    def extract_summary(self, text):
        ...
        for i, line in enumerate(lines):
            ...
            if cleaned_line in [keyword.lower() for keyword in summary_keywords]:
                summary_start = i + 1
                break
            if summary_start is not None:
                ...
                for line in lines:
                    ...
                    if cleaned_line in [keyword.lower() for keyword in section_keywords]:
                        break
                    if re.search(r'\b(?:email|phone|address|tel|mobile|linkedin|github)\b',line.lower()):
                        continue
                    starting_lines.append(line)
                    if len(starting_lines) >= 5:
                        break
                    if starting_lines:
                        potential_summary = ' '.join(starting_lines)
                        if len(potential_summary.split()) > 10:
                            return potential_summary.strip()
                    return ''
